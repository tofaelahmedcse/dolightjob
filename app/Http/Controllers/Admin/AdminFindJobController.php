...
class AdminFindJobController extends Controller
{
    public function find_job()
    {
        $all_reg = region_country::all();
        return view('admin.findjob.findJob', compact('all_reg'));
    }
    ...
    public function find_job_get_all(Request $request)
    {
        ...
        return response()->json([
            'notices' => $all_jobs,
            'view' => View::make('admin.findjob.include.findJobTbl', compact('all_jobs'))->render(),
    ...
    public function find_job_details($id)
    {
        ...
        return view('admin.findjob.jobDetails', compact('job_details', 'applied_user'));
    }
}
