...
@section('subadmin')
    <nav class="navbar navbar-light bg-light">
        <div class="container-fluid">
            <h4 class="card-title">Rejected Withdraw List</h4>
            <form class="d-flex">
        ...
        $(document).ready(function () {
            ...
            $(window).scroll(function() {
                ...
                if (isBottom && currentscrollHeight < scrollHeight) {
                    page++;
                    //alert('calling...');
                    var myurl = ENDPOINT + '/subadmin/rejected-withdraw-get?page=' + page
                    getData(myurl);
            ...
            function getRejWithdraw(){
                ...
                $.ajax({
                    type: "POST",
                    url: "{{route('subadmin.rejected.withdraw.get')}}",
                    data: {
                        '_token': "{{csrf_token()}}",
                        'type' : 1,
                    ...
                    success: function (data) {
                        ...
                        $('.show_rej_with').empty();
                        if (data.count_ses > 0){
                            $('.show_rej_with').append(data.view);
                        }
                        $('.show_animation').hide();
                    }
                });
