        ...
        $(document).ready(function () {
            ...
            $(window).scroll(function() {
                ...
                if (isBottom && currentscrollHeight < scrollHeight) {
                    page++;
                    //alert('calling...');
                    var myurl = ENDPOINT + '/subadmin/rejected-deposit-get?page=' + page
                    getData(myurl);
            ...
            function getRejDep(){
                ...
                $.ajax({
                    type: "POST",
                    url: "{{route('subadmin.rejected.deposit.get')}}",
                    data: {
                        '_token': "{{csrf_token()}}",
                        'type' : 1,
                        'searchdep':searchdep
