        ...
        $(document).ready(function () {
            ...
            $(window).scroll(function() {
                ...
                if (isBottom && currentscrollHeight < scrollHeight) {
                    page++;
                    //alert('calling...');
                    var myurl = ENDPOINT + '/subadmin/inactive-users-get?page=' + page
                    getData(myurl);
            ...
            function getInActUsers(){
                ...
                $.ajax({
                    type: "POST",
                    url: "{{route('subadmin.inactive.users.get')}}",
                    data: {
                        '_token': "{{csrf_token()}}",
                        'type' : 1,
                    ...
                    success: function (data) {
                        ...
                        $('.show_inact_usr').empty();
                        if (data.count_ses > 0){
                            $('.show_inact_usr').append(data.view);
                        }
                        $('.show_animation').hide();
                    }
                });
