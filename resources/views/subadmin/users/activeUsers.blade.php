...
@section('subadmin')
    <nav class="navbar navbar-light bg-light">
        <div class="container-fluid">
            <h4 class="card-title">Active Users List</h4>
            <form class="d-flex">
        ...
        $(document).ready(function () {
            ...
            $(window).scroll(function() {
                ...
                if (isBottom && currentscrollHeight < scrollHeight) {
                    page++;
                    //alert('calling...');
                    var myurl = ENDPOINT + '/subadmin/active-users-get?page=' + page
                    getData(myurl);
            ...
            function getActUsers(){
                ...
                $.ajax({
                    type: "POST",
                    url: "{{route('subadmin.active.users.get')}}",
                    data: {
                        '_token': "{{csrf_token()}}",
                        'type' : 1,
