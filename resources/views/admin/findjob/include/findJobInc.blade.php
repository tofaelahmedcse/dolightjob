    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $('.reg_fil').change(function () {
                ...
                $.ajax({
                    type: "POST",
                    url: "{{route('admin.job.find.mcat.by.reg')}}",
                    data: {
                        '_token': "{{csrf_token()}}",
                        'reg_fil': reg_fil,
                    },
            ...
            $('.mcat_filter').change(function () {
                ...
                $.ajax({
                    type: "POST",
                    url: "{{route('admin.job.find.scat.by.mcat')}}",
                    data: {
                        '_token': "{{csrf_token()}}",
            ...
            $.ajax({
                type: "POST",
                url: "{{route('admin.find.job.get.all')}}",
                data: {
                    '_token': "{{csrf_token()}}",
                },
                success: function (data) {
            ...
            $(window).scroll(function() {
                ...
                if (isBottom && currentscrollHeight < scrollHeight) {
                    ...
                    console.log(page);
                    var myurl = ENDPOINT + '/admin/find-job-get-all?page=' + page
                    getData(myurl);
