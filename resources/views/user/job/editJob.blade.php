                ...
                <div class="card">
                    <div class="card-body">
                        <div class="mb-3">
                            ...
                            <input type="text" name="job_title" value="{{$job_edit->job_title}}" class="form-control"
                                   id="project-title-input" placeholder="Enter project title">
                            <input type="hidden" name="job_edit_id" value="{{$job_edit->id}}" class="form-control"
                                   id="project-title-input" placeholder="Enter project title">
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            @endif
                            <input class="form-control" name="thumbnail" id="project-thumbnail-img" type="file"
                        ...
                        <div class="mb-3">
                            <label class="form-label" for="project-title-input">What specific tasks need to be
                                Completed?</label>
                            <textarea type="text" name="specific_task" cols="7" rows="7" class="form-control"
                        ...
                        <div class="mb-3">
                            <label class="form-label" for="project-title-input">Required proof the job was
                                Completed</label>
                            <textarea type="text" name="require_proof" cols="7" rows="7" class="form-control"
                                      id="project-title-input"
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4">
                                <div>
                                    ...
                                    <input type="text" class="form-control each_workder_earn"
                                           value="{{$job_edit->each_worker_earn}}" readonly>
                                </div>
                            </div>
                            <br>
                            <br>
                            ...
                            <div class="col-lg-4">
                                <div>
                                    ...
                                    <input type="text" name="est_job_cost" class="form-control total_est"
                                           value="{{$job_edit->est_job_cost}}" readonly>
                                    <input type="hidden" class="form-control total_est_old"
                                           value="{{$job_edit->est_job_cost}}" readonly>
                                </div>
                            </div>
                        </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div>
                            ...
                            3. <label for="choices-text-input" class="form-label"> you change the
